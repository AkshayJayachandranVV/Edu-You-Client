    ...
    <div className="flex h-screen bg-black">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex-1 p-6 bg-gray-900 overflow-y-auto">
          ...
          <div className="flex justify-end mb-6 mr-52">
            <button
              className="bg-violet-700 text-white font-bold py-2 px-6 rounded-lg shadow-lg hover:scale-105 hover:shadow-2xl transition transform duration-200 w-48 h-14 hover:bg-violet-800"
              onClick={goCourse}
            >
              + Add Course
            </button>
