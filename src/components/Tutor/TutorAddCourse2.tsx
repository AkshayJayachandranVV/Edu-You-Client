...
const AddCoursePage2: React.FC<AddCoursePage2Props> = ({ onNext, onBack }) => {
  const dispatch = useDispatch();

  // Get course data from Redux state
  const courseData = useSelector((state: any) => state.course.courseDetails); // Adjust according to your Redux state structure
